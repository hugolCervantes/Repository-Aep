/*
 * Hugols_definitions.h
 *
 *  Created on: Oct 11, 2015
 *      Author: emma
 */

#ifndef HUGOLS_DEFINITIONS_H_
#define HUGOLS_DEFINITIONS_H_
   ...
   *
   * file name:      HUGOLS_DEFINITIONS.h
   *
   * created by:     ****************
   *
   * date created:   **************
   ...
   *09/05/2003   Oswaldo Garcia              Created, modified from System__Public.h 
   *                              at corePCM.
